    ...
    <>
      ...
      <div
        className={`z-40 glass-panel flex flex-col animate-slide-up min-h-0 overflow-hidden ${
          mobile
            ? // Clear MobileDock (z-50): dock ≈ 4.5–5.5rem + safe; keep composer above it.
              'fixed inset-x-2 top-[max(0.5rem,var(--safe-top))] bottom-[calc(6.25rem+var(--safe-bottom))] rounded-2xl'
