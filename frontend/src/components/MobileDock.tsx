...
export type MobileSheet = 'none' | 'controls' | 'node' | 'ai' | 'tx';
...
export default function MobileDock({
  ...
  const btn = (active: boolean) =>
    `flex flex-col items-center justify-center gap-0.5 min-w-[3.25rem] px-2 py-1.5 rounded-xl text-[10px] font-mono uppercase transition-all ${
