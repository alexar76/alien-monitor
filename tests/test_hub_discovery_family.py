...
from canonical_peers import canonical_node_id_for_peer  # noqa: E402
...
def test_momus_hub_peer_is_not_a_new_oracle():
    peer = {
    ...
    assert family_node_id_for_peer(peer) is None
