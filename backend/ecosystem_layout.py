...
NODE_POSITIONS: dict[str, dict[str, float]] = {
    ...
    # The hearth sits above the Hub–THEMIS–Factory triangle: it hosts sellers on the
    # operator's machines, Hub stays the catalogue, THEMIS may refuse a start.
    # Nearest neighbour is THEMIS at ~5.03 and Factory at ~6.25 — clear of the 2.5
    # shelf floor and of the 4.5 the BASANOS-style separation tests enforce.
    "hestia": {"x": 3.2, "y": 7.2, "z": -6.2},
    ...
    # DOLOS — dynamic EVM red team, security tier beside BASANOS (static). Kept >4.5 from
    # the oracle ring and clear of BASANOS; the two are related but not stages of each other.
    "dolos": {"x": 12.5, "y": -8.5, "z": 5.0},
    ...
    # HISTOR: the public memory of what MCP servers advertised. Above and behind WARDEN (which
    # consults it at connect time) and MOMUS, on the far west edge of the security sector.
    "histor": {"x": -15.5, "y": 5.5, "z": 1.0},
