...
def _apply_all(nodes: list[dict], *, tick: int, escrow: str, rpc: str,
    ...
    steps: tuple[tuple[str, Any], ...] = (
        ...
        ("histor", lambda: apply_histor_graph(nodes, mode="universe")),
        ...
        ("hestia", lambda: apply_hestia_graph(nodes, mode="universe")),
        ("dolos", lambda: apply_dolos_graph(nodes, mode="universe")),
