...
class VirtualUniverse:
    ...
    def seed_entities(self):
        ...
        fa.position = fa_spec["position"]
        fa.url = fa_spec["url"]
        fa.metrics = dict(fa_spec.get("metrics") or {})
        fa.status = fa_spec.get("status", "offline")
        fa.color = "#7ee787"
    ...
    def tick_universe(self) -> dict:
        ...
        apply_hephaestus_graph(graph_nodes, mode="universe")
        ...
        apply_logos_to_nodes(graph_nodes, fetch_logos_status_sync(timeout=2.0))
